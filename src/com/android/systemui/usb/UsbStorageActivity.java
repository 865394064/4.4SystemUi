...
public class UsbStorageActivity extends Activity
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.usb_storage);
        if(FeatureOption.CENON_DW5)
        	findViewById(R.id.rootView).setBackgroundResource(R.drawable.usb_android_dw5);
    ...
    protected void onResume() {
		...
		/**Begin: added by lzp for bug [2597] **/
		final Intent updateIntent = new Intent(Intent.ACTION_UPDATE_STATUSBAR);
		updateIntent.putExtra("status_bar_bg_color_index", 2);
		updateIntent.putExtra("status_bar_font_white", true);//modified by lzp for bug [2582]
		sendBroadcast(updateIntent);
		/**End: added by lzp for bug [2597] **/
    }
