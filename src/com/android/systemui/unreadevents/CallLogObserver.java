...
public class CallLogObserver extends UnReadObserver {
    ...
    private static final String MISS_CALL_SELECTION = "(" +
    ...
    public CallLogObserver(Handler handler, UnReadMessageLayout newEventView, long createTime) {
