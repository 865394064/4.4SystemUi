...
public class PhoneStatusBarView extends PanelBar {
    ...
    public PhoneStatusBarView(Context context, AttributeSet attrs) {
        ...
        mFullWidthNotifications = mSettingsPanelDragzoneFrac <= 0f;
          mIconPolicy= new PhoneStatusBarPolicy(context);
    }
    ...
    public PanelView selectPanelForTouch(MotionEvent touch) {
        ...
        if (mFullWidthNotifications) {
            ...
            if(mNotificationPanel == null) return null;//added by lzp
    ...
    public void onPanelPeeked() {
       ...
       if(mBar!=null)
       isWhite=mBar.preWhite;
       if(!isWhite)
       mIconPolicy.updateSystemIconDrawables(true);
       /*edn by xujia*/
    }
    ...
    public void onAllPanelsCollapsed() {
        ...
        /*begin added by xujia*/
        if(!isWhite)
         mIconPolicy.updateSystemIconDrawables(false);
        /*end added by xujia*/
        mFadingPanel = null;
        mLastFullyOpenedPanel = null;
		final Intent mPanelClose=new Intent("statusbar_panel_is_close");
	 mContext.sendBroadcast(mPanelClose);
    }
	...
	final Intent mPanelShow=new Intent("statusbar_panel_is_show");
	 mContext.sendBroadcast(mPanelShow);
    }

    @Override
    public boolean onTouchEvent(MotionEvent event) {
    if(mBar!=null){
    	//added by wang 20130906 start
    	if(mBar.isControlCenterShow()) {
			return false;
    	}
		//added by wang 20130906 end
    ...
    public void panelExpansionChanged(PanelView panel, float frac) {
        ...
        if (panel == mFadingPanel && mScrimColor != 0 &&false /*ActivityManager.isHighEndGfx()*/) {
            if (mShouldFade) {
    ...
    /// M: Set visible piles as HW layer to speed up tracking the notification panel
    @Override 
    public void onTrackingStarted(PanelView panel) {
        super.onTrackingStarted(panel);
        mBar.setPileLayers(View.LAYER_TYPE_HARDWARE);
    ...
    public void onTrackingStopped(PanelView panel) {
        ...
        mBar.setPileLayers(View.LAYER_TYPE_NONE);
