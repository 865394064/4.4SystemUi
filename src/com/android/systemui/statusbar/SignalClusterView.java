...
public class SignalClusterView
    ...
    private IconIdWrapper[][] mMobileStrengthId_double;
    ...
    public SignalClusterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMobileStrengthId_double = new IconIdWrapper[2][];
        for(int i = 0;i < 2 ; i++) {
            mMobileStrengthId_double[i] = new IconIdWrapper[2];
            for (int j = 0 ; j < 2 ; j++) {
                mMobileStrengthId_double[i][j] = new IconIdWrapper(0);
            }
        }
        //im1=tm.getSubscriberIdGemini(0);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        vs = (View) findViewById(R.id.ciew1);
...
//added by wang 20130731 start
	public void updateSignalColor(boolean white) {
        ...
        //Log.d("hjz6","updateSignalColor="+white);
	        Intent intent	=new Intent("back_button_text_color");
		 intent.putExtra("isWhite",white);
		 getContext().sendBroadcast(intent);
        mobile_signal_2.setImageResource(white ? (R.drawable.stat_sys_gemini_signal_4_second_white):(R.drawable.stat_sys_gemini_signal_4_second_black));
	}
    ...
    private void apply() {
       ...
       // Log.d("hjz3","apply"+"mMobileVisible"+mMobileVisible+"mIsAirplaneMode"+mIsAirplaneMode+"tm"+im1);
        ...
        if(im1!=null || im2!=null){
            ...
            mobile_signal_2.setVisibility(View.GONE);
        }
        if(im1!=null && im2!=null){
            mMobile.setImageResource(mMobileStrengthId.getIconId());
            no_sims_combo.setVisibility(View.GONE);
            ...
            mobile_signal_2.setVisibility(View.VISIBLE);
           // mobile_signal_2.setImageResource(R.drawable.stat_sys_gemini_signal_4_second_white);
            mobile_signal_2.setImageResource(showhite ? (R.drawable.stat_sys_gemini_signal_4_second_white):(R.drawable.stat_sys_gemini_signal_4_second_black));
        }else{
            mobile_signal_2.setVisibility(View.GONE);
