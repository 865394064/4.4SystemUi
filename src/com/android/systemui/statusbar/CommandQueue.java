...
public class CommandQueue extends IStatusBar.Stub {
	...
	//added by wang 20130823 start
	private static final int MSG_IS_CONTROL_CENTER_SHOW = 20 << MSG_SHIFT;
	private static final int MSG_HIDE_CONTROL_CENTER = 21 << MSG_SHIFT;
	//added by wang 20130823 end

    //begin: add by joyisn 20141225 for keyguard statusbar animation 	
	private static final int MSG_CHANGE_STATUSBAR_ALPHA = 22 << MSG_SHIFT;
    //end: add by joyisn 20141225 for keyguard statusbar animation 	
    ...
    //end: add by joyisn 20141225 for keyguard statusbar animation 	
            public void setBitMapFromActivity();//added by yuhuizhong xss 
    }
	...
	public void hideControlCenter() {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_HIDE_CONTROL_CENTER, 0, 0, null).sendToTarget();
        }
	}
	//added by wang 20130823 end
    ...
    //begin: add by joyisn 20141225 for keyguard statusbar animation 	
     public void onLockScreenAlphaChanged(float alpha){
        synchronized (mList) {
            mHandler.obtainMessage(MSG_CHANGE_STATUSBAR_ALPHA, 0, 0, alpha).sendToTarget();//obtainMessage(int what, int arg1, int arg2, Object obj)
        }	
     }
    //end: add by joyisn 20141225 for keyguard statusbar animation 
    ...
    private final class H extends Handler {
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                /// @}
                //added by wang 20130823 start
                case MSG_HIDE_CONTROL_CENTER:
                    mCallbacks.hideControlCenter();
                    break;
                //added by wang 20130823 end

                //add by joyisn
		   case MSG_CHANGE_STATUSBAR_ALPHA:
		   	mCallbacks.onLockScreenAlphaChanged((Float)msg.obj);
            }
        }
    }
	...
	public void setBitMapFromActivity(){
		synchronized (mList) {
		            mCallbacks.setBitMapFromActivity();
        	}
	}
