...
public class BluetoothController extends BroadcastReceiver {
    ...
    private int mIconId = R.drawable.stat_sys_data_bluetooth_darker;//changed by wang 20130731 from 'stat_sys_data_bluetooth' to 'stat_sys_data_bluetooth_darker'
    ...
    public void handleConnectionStateChange(int connectionState) {
        ...
        if (connected) {
            //mIconId = R.drawable.stat_sys_data_bluetooth_connected;//removed by wang 20130730
            mIconId = mWhiteColor ? R.drawable.stat_sys_data_bluetooth_darker : R.drawable.stat_sys_data_bluetooth_darker;//added by wang 20130730
            mContentDescriptionId = R.string.accessibility_bluetooth_connected;
        } else {
            //mIconId = R.drawable.stat_sys_data_bluetooth;//removed by wang 20130730
            mIconId = mWhiteColor ? R.drawable.stat_sys_data_bluetooth_darker : R.drawable.stat_sys_data_bluetooth_darker;//added by wang 20130730
...
//added by wang 20130730 start
	private boolean mWhiteColor = false;
	public void setBluetoothColor(boolean white) {
		mWhiteColor = white;
		mIconId = mWhiteColor ? R.drawable.stat_sys_data_bluetooth_darker : R.drawable.stat_sys_data_bluetooth_darker;
		refreshViews();
	}
//added by wang 20130730 end	
}
