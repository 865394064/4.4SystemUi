...
//added by wang 20130726 start
    //white Signal for SIMIndicator
    public static final int[] TELEPHONY_SIGNAL_STRENGTH_WHITE = {
        //R.drawable.stat_sys_iphone_signal_0_white,
        //R.drawable.stat_sys_iphone_signal_1_white,
        //R.drawable.stat_sys_iphone_signal_2_white,
        //R.drawable.stat_sys_iphone_signal_3_white,
        //R.drawable.stat_sys_iphone_signal_4_white,
        //R.drawable.stat_sys_iphone_signal_5_white
        R.drawable.stat_sys_gemini_signal_0_white,
        R.drawable.stat_sys_gemini_signal_1_white,
        R.drawable.stat_sys_gemini_signal_2_white,
        R.drawable.stat_sys_gemini_signal_3_white,
        R.drawable.stat_sys_gemini_signal_4_white,
    ...
    //white Signal for SIMIndicator
    public static final int[] TELEPHONY_SIGNAL_STRENGTH_BLACK = {
        //R.drawable.stat_sys_iphone_signal_0_black,
        //R.drawable.stat_sys_iphone_signal_1_black,
        //R.drawable.stat_sys_iphone_signal_2_black,
        //R.drawable.stat_sys_iphone_signal_3_black,
        //R.drawable.stat_sys_iphone_signal_4_black,
        //R.drawable.stat_sys_iphone_signal_5_black
            R.drawable.stat_sys_gemini_signal_0_black,
            R.drawable.stat_sys_gemini_signal_1_black,
            R.drawable.stat_sys_gemini_signal_2_black,
            R.drawable.stat_sys_gemini_signal_3_black,
            R.drawable.stat_sys_gemini_signal_4_black,
            R.drawable.stat_sys_gemini_signal_4_black,
    };
	public static int[] getTelephonySignalStrength(boolean white) {
		return white ? TELEPHONY_SIGNAL_STRENGTH_WHITE : TELEPHONY_SIGNAL_STRENGTH_BLACK;
	}
//added by wang 20130726 end
    ...
    static final int[][] DATA_G = {
        ...
        //add by xujia begin
            public static final int[] DATA_3G_WHITE = {
               R.drawable.white_3g
            };

       public static final int[] DATA_3G_BLACK={
            R.drawable.black_3g
        };
 
        public static int[] getTelephonyTypeIcon(boolean white) 
        {
            return white ? DATA_3G_WHITE : DATA_3G_BLACK;
        }

 		public static final int[] DATA_4G_WHITE = {
            R.drawable.white_4g
         };

	    public static final int[] DATA_4G_BLACK={
	         R.drawable.black_4g
	     };

	     public static int[] get4GTelephonyTypeIcon(boolean white) 
	     {
	         return white ? DATA_4G_WHITE : DATA_4G_BLACK;
	     }
        //end by xujia

                //add by xujia begin 20130902
            public static final int[] DATA_E_WHITE = {
               R.drawable.white_e
            };

       public static final int[] DATA_E_BLACK={
            R.drawable.black_e
        };
 
        public static int[] getTelephonyETypeIcon(boolean white) 
        {
            return white ? DATA_E_WHITE : DATA_E_BLACK;
        }
        //end by xujia
