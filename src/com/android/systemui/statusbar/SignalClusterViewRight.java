...
public class SignalClusterViewRight
    ...
    public SignalClusterViewRight(Context context) {
        this(context, null);
        Log.d("hjz3","3");
        //im1=tm.getSubscriberIdGemini(0);
    }

    public SignalClusterViewRight(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        Log.d("hjz3","2");
        //im1=tm.getSubscriberIdGemini(0);
    }

    public SignalClusterViewRight(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onAttachedToWindow() {
        ...
        mMobileNameView       = (TextView) findViewById(R.id.mobile_name_2);
        /// M: Support SIM Indicator. 
