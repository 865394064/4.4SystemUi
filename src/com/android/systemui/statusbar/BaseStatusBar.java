...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    private ArrayList listKey = new ArrayList();//add by csc
    int count;// add by csc
    ...
    public void start() {
        ...
        filter.addAction("DELETE_ALL_NOTIFICATION");// add by csc
        mContext.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                }else if ("DELETE_ALL_NOTIFICATION".equals(action)){
    ...
    protected View.OnLongClickListener getNotificationLongClicker() {
        return new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                final int notificationId=v.getId();
        ...
        try {
            //add by xujia 20130912
                Intent save = new Intent();
                 save.setAction("save_bitmap");
                  mContext.sendBroadcast(save);
                  //end by xujia 
                System.out.println("send bro activity");
            ...
            if (firstTask == null) {
                if (RecentsActivity.forceOpaqueBackground(mContext)) {
                    ...
                    mContext.startActivityAsUser(intent, null /*opts.toBundle()*/, new UserHandle(
                ...
                intent.putExtra(RecentsActivity.WAITING_FOR_WINDOW_ANIMATION_PARAM, false);//true - >false
                mContext.startActivityAsUser(intent, /*opts.toBundle()*/null, new UserHandle(
                        UserHandle.USER_CURRENT));
            }
            return;
        ...
        public void handleMessage(Message m) {
            ...
            switch (m.what) {
             ...
             case MSG_OPEN_SEARCH_PANEL:
                 Slog.d("kay", "opening search panel");
                 if (mSearchPanelView != null && mSearchPanelView.isAssistantAvailable()) {
                     mSearchPanelView.show(true, true);
                 }
                 break;
             case MSG_CLOSE_SEARCH_PANEL:
                 Slog.d("kay6", "closing search panel");
    ...
    protected  boolean inflateViews(NotificationData.Entry entry, ViewGroup parent) {
        ...
        count++;
        Intent i = new Intent("IS_DELETE_ALL_NOTIFICATION");
        i.putExtra("COUNT", ""+count);
        mContext.sendBroadcast(i);
        Log.d("chenshichun",""+this.getClass().getCanonicalName()+":::::::::::::::::::::IS_DELETE_ALL_NOTIFICATION");
        // end add by csc
       ...
       // View row = inflater.inflate(R.layout.status_bar_notification_row, parent, false);
        ...
        View row= inflater.inflate(R.layout.status_bar_notification_row_header,parent,false);//hjz
        ...
        dipstv=(View)row.findViewById(R.id.relative);
       final View scrol1=(View)row.findViewById(R.id.scrol1);
        final View scrol2=(View)row.findViewById(R.id.scrol2);
        scrol1.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent motionEvent) {
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        pressY = motionEvent.getRawX();
                        break;
                    case MotionEvent.ACTION_MOVE:
                        isMove = true;
                        int dx = (int) (motionEvent.getRawX() - pressX);
                        Log.d("hjz", "dx="+dx+"scrol1.getX()=="+scrol1.getX());
                        scrol1.setX(scrol1.getX() + dx);
                        if(scrol1.getX() >10){
                            FrameLayout.LayoutParams rightLp = new FrameLayout.LayoutParams(0, scrol1.getHeight());
                            scrol2.setLayoutParams(rightLp);
                            scrol2.setVisibility(View.GONE);
                            Log.d("hjz","scrol2GONE");
                        }else if(scrol1.getX() <= 10){
                            FrameLayout.LayoutParams rightLp = new FrameLayout.LayoutParams((int)Math.abs(scrol1.getX()) -10, scrol1.getHeight());
                            scrol2.setLayoutParams(rightLp);
                            scrol2.setVisibility(View.VISIBLE);
                            Log.d("hjz","scrol1.getWidth()="+""+scrol1.getWidth()+"scrol2.gettWidth()"+scrol2.getWidth()+"scrol2.getx"+scrol2.getX());
                            scrol2.setX(scrol1.getX()+scrol1.getWidth()+10);
                        }
                        break;
                    case MotionEvent.ACTION_UP:
                        int dx1 = (int) (motionEvent.getRawX() - pressX);
                        Log.d("hjz","cc="+dx1+"scrol1.getX()="+scrol1.getX());
                        isMove = false;
                        if(dx1>0){
                            if(scrol1.getX()  > -90){
                                scrol1.setX(0);
                                scrol2.setVisibility(View.GONE);
                                Log.d("hjz","scrol2GONE");
                            }else if(scrol1.getX()  <= -90){
                                FrameLayout.LayoutParams rightLp = new FrameLayout.LayoutParams(60, scrol1.getHeight());
                                scrol1.setX(-129);
                                scrol2.setLayoutParams(rightLp);
                                //scrol2.setX(scrol1.getX()+scrol1.getWidth()+10);
                                scrol2.setX(-50);
                            ...
                            if(scrol1.getX()  <= -90){
                                FrameLayout.LayoutParams rightLp = new FrameLayout.LayoutParams(119, scrol1.getHeight());
                                scrol1.setX(-129);
                                scrol2.setLayoutParams(rightLp);
                                scrol2.setX(559);
                                scrol2.setVisibility(View.VISIBLE);
        ...
        ImageView notificationIcon=(ImageView)row.findViewById(R.id.notification_icon);
        TextView notificationTitle=(TextView)row.findViewById(R.id.notification_label);
        TextView tvclean=(TextView)row.findViewById(R.id.delete);
        ImageView xbutton=(ImageView)row.findViewById(R.id.xbutton);
        xbutton.setVisibility(View.GONE);
        ClearNotificationClicker clearNotificationListener=new ClearNotificationClicker(entry.key);
            xbutton.setOnClickListener(clearNotificationListener);
        scrol2.setOnClickListener(clearNotificationListener);
        tvclean.setOnClickListener(clearNotificationListener);
        Drawable icon;
        try{
                ApplicationInfo  applicationInfo=  mContext.getPackageManager().getApplicationInfo(sbn.pkg, 0);
                icon = mContext.getPackageManager().getApplicationIcon(applicationInfo);
                notificationIcon.setImageDrawable(icon);
                String applicationName =   (String)  mContext.getPackageManager().getApplicationLabel(applicationInfo);  
                 notificationTitle.setText(applicationName);
           }catch(Exception e){

           }
        //String title= mContext.getPackageManager().getApplicationInfo(sbn.pkg, 0).getApplicationInfo().title;
...
//    	for(Iterator i = listKey.iterator();i.hasNext(); ){
//    		String str = (String) i.next();
//    		removeNotificationViews(str,null);
//    	}
//    	listKey.clear();
//    	listKey = null;
        for(int i=0;i<listKey.size();i++){
            Log.d("chenshichun","(String) listKey.get(i):::::::::::"+i);
            IBinder key = (IBinder) listKey.get(i);
...
/*begin added by xujia 20131122*/
    private class ClearNotificationClicker implements View.OnClickListener{
            private IBinder mKey;

            
             ClearNotificationClicker(IBinder key){
                    mKey=key;
