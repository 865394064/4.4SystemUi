...
public class NetworkOverLimitActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        builder.setNegativeButton(
                R.string.data_usage_disabled_dialog_enable, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Slog.v(TAG, "NetworkOverLimitActivity click reenable");
                        isReenabled=true;
        ...
        Slog.v(TAG, "NetworkOverLimitActivity create");

        ///M: modify Window Type for ALPS00706555, we need a window type to fix window layer position
